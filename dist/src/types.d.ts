...
export declare const REQUIRED_SUMMARY_SECTIONS: readonly ["Goal", "Constraints", "Confirmed facts", "Decisions", "Files and paths", "Commands and IDs", "Open work", "Agent/background state", "Evidence and unresolved uncertainty"];
